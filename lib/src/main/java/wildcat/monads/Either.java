...
public sealed interface Either<L extends @NonNull Object, R extends @NonNull Object>
    ...
    <U extends @NonNull Object> wildcat.monads.Either<? extends L, ? extends U> map(
            @NonNull NonNullFunction<? super R, ? extends U> mapping);

    <U extends @NonNull Object> wildcat.monads.Either<? extends U, ? extends R> mapLeft(
            @NonNull NonNullFunction<? super L, ? extends U> mapping);

    <U extends @NonNull Object> wildcat.monads.Either<? extends L, ? extends U> flatMap(
            @NonNull NonNullFunction<? super R, ? extends wildcat.monads.Either<? extends L, ? extends U>> mapping);

    <U extends @NonNull Object> wildcat.monads.Either<? extends U, ? extends R> flatMapLeft(
            @NonNull NonNullFunction<? super L, ? extends wildcat.monads.Either<? extends U, ? extends R>> mapping);

    <OL extends @NonNull Object, OR extends @NonNull Object> wildcat.monads.Either<? extends OL, ? extends OR> bimap(
    ...
    record Left<L extends @NonNull Object, R extends @NonNull Object>(L value) implements Either<L, R> {
        @Override
        public <U extends @NonNull Object> wildcat.monads.Either<? extends L, ? extends U> map(
                final @NonNull NonNullFunction<? super R, ? extends U> mapping) {
            return genericCast(this);
        }

        @Override
        public <U extends @NonNull Object> wildcat.monads.Either<? extends U, ? extends R> mapLeft(
                final @NonNull NonNullFunction<? super L, ? extends U> mapping) {
            return new Left<>(mapping.apply(value()));
        }

        @Override
        public <U extends @NonNull Object> wildcat.monads.Either<? extends L, ? extends U> flatMap(
                final @NonNull NonNullFunction<? super R, ? extends wildcat.monads.Either<? extends L, ? extends U>> mapping) {
            return genericCast(this);
        }

        @Override
        public <U extends @NonNull Object> wildcat.monads.Either<? extends U, ? extends R> flatMapLeft(
                final @NonNull NonNullFunction<? super L, ? extends wildcat.monads.Either<? extends U, ? extends R>> mapping) {
            return mapping.apply(value());
        }

        @Override
        public <OL extends @NonNull Object, OR extends @NonNull Object> wildcat.monads.Either<? extends OL, ? extends OR> bimap(
