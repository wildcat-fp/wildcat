 ...
 *     </li>
 * </ul>
 * @param <For> The type constructor for which the Functor instance is defined. This should be a higher-kinded type (Kind.k).
 * 
 * @author Matthew Cory
 */
public interface Functor<For extends Functor.k> {
     ...
     *
     * @param fa The structure containing the value to be transformed.
     * @param f  The function to apply to the value inside 'fa'.
     * @param <A> The type of the value inside 'fa'.
     * @param <B> The type of the value in the resulting structure after applying 'f'.
